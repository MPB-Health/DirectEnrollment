...
export async function generateEnrollmentPDF(formData: FormData): Promise<Blob> {
  ...
  const questionnaireData = [
    ...
    ['Primary Member Medical Conditions *\n\nHas the primary member experienced symptoms of, been diagnosed with, or been treated for any condition within the past 24 months?\n\n*Note: A $25.00 annual fee is charged at the time of enrollment and each year thereafter. This fee covers your membership in the MPowering Benefits Association.', formData.questionnaireAnswers.zionmh3 || 'N/A'],
    ...
    ['Medical Cost Sharing/Health Share Authorization: I acknowledge and understand that Medical Cost Sharing/Health Share is not insurance and that I am always personally responsible for the payment of my own medical bills.', formData.questionnaireAnswers.medicalCostSharingAuth ? 'YES' : 'NO'],
